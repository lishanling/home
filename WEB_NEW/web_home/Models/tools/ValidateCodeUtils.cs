...
namespace web_home.Models
{
...

    {
        ...
        public static ValidateCodeUtils Instance { set { _instance = _instance ?? (_instance = new ValidateCodeUtils()); } }
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                while (code == '\0' || filter.Contains(code))
                {
...

                    {
                        ...
                        case Digital:code = (char)('0' + (char)(rand % 10));break;
                        case Letter: code = (char)('A' + (char)(rand % 26)); break;
